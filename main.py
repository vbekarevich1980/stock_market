...
if __name__ == "__main__":
    ...
    job_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), 'crawls', 'stock_market'))
    ...
    time.sleep(15)
    os.system(
        'docker run -d -p 8050:8050 --rm --name splash scrapinghub/splash'
    )
    time.sleep(5)
    ...
    chart_column_dict = {"revenue": "AO", "net_income": "AP", "esp": "AQ",
                         "price_sales": "AR", "pe_ratio": "AS",
                         "price_book": "AT", "market_cap": "AU", }
    ...
    destination_wb_obj.save('stock_market_output.xlsx')
